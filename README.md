...
## Version 1.0
STRO4K 1.0 has the additional feature of being able to display the evaluation and the currently considered best move during the search. However, there are some limitations.
* The apparent 'centipawn' evaluation is actually displayed in octal with a granularity of one 256th of a pawn.
* The depth is always displayed as `1`. `cutechess-cli` seems to require a depth. Otherwise, it will not record the evaluation.
