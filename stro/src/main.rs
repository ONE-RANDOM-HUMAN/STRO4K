fn main() {
    ...
    // SPSA
    println!("option name SNmp type spin default 84 min 0 max 1024");
    println!("option name FPrune type spin default 114 min 0 max 1024");
    println!("option name DeltaP type spin default 84 min 0 max 1024");
    println!("option name DeltaN type spin default 425 min 0 max 4096");
    println!("option name DeltaB type spin default 425 min 0 max 4096");
    println!("option name DeltaR type spin default 648 min 0 max 4096");
    println!("option name DeltaQ type spin default 1246 min 0 max 4096");
    println!("option name DeltaBase type spin default 97 min 0 max 1024");
    println!("option name DeltaImprove type spin default 39 min 0 max 1024");
    println!("option name LmrDepth type string default 0.18955529530449658");
    println!("option name LmrMove type string default 0.13077897217303366");
    println!("option name LmrImprove type string default -0.7704614426171933");
    println!("option name NmrBase type string default 3.7503942439305984");
    println!("option name NmrDepth type string default 0.1723964148950344");
    println!("option name NmrImprove type string default -0.5950016905881689");
