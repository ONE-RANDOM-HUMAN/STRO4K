...
const MATERIAL_EVAL: [Eval; 5] = [
    Eval(267, 267),
    Eval(815, 814).accum_to(MOBILITY_EVAL[0], -4),
    Eval(848, 812).accum_to(MOBILITY_EVAL[1], -6),
    Eval(1348, 1399).accum_to(MOBILITY_EVAL[2], -7),
    Eval(2737, 2400).accum_to(MOBILITY_EVAL[3], -13),
];

const MOBILITY_EVAL: [Eval; 4] = [Eval(29, 20), Eval(28, 20), Eval(27, 21), Eval(29, 19)];

const BISHOP_PAIR_EVAL: Eval = Eval(170, 169);
