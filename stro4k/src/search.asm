...
F_PRUNE_MARGIN equ 74
STATIC_NULL_MOVE_MARGIN equ 74
SEE_PRUNE_MARGIN equ -62
...
.no_static_nmp:
    ...
    mov ecx, dword [rbp + 8]
    imul esi, ecx, 48
    lea esi, [rsi + 2 * rax + 607 + 256] ; + 256 since formula is depth - r - 1
...
.no_fprune_move:
    ...
    ; conthist
    ; rsi is preserved from board_is_check
