...
F_PRUNE_MARGIN equ 84
STATIC_NULL_MOVE_MARGIN equ 81
SEE_PRUNE_MARGIN equ -61
...
.no_static_nmp:
    ...
    mov ecx, dword [rbp + 8]
    imul esi, ecx, 45
    lea esi, [rsi + 2 * rax + 570 + 256] ; + 256 since formula is depth - r - 1
