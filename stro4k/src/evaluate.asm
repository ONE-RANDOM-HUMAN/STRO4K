...
.no_mobility:
    ...
    vpmovsxbw xmm3, qword [rbp + PROTECTED_PASSED_PAWN_EVAL - EVAL_WEIGHTS + 2 * rax - 4]
...
.no_doubled_pawn:
    ...
    bt r13, rbx
    jnc .no_protected_passed_pawn

    vpaddw xmm0, xmm0, xmm3
.no_protected_passed_pawn:
.no_passed_pawn:
    ; isolated pawn
    test rdx, r13
